var jpdbToken = "90932246|-31949276847938755|90954364";
var jpdbBase = "http://api.login2explore.com:5577";
var jpdbIml = "/api/iml";
var jpdbName = "student-table";
var jpdbRel = "school-db";
var jpdbIrl = "/api/irl";
...
function getEmp() {
    ...
    if (resJsonObj.status === 400) {
        alert("The requested data was not found kindly Create a new one to save the data into the Database!")
...
function changeData() {
    ...
    $("#empChange").prop("disabled", false);
    var keyFromLs = localStorage.getItem("Rec_No_")
